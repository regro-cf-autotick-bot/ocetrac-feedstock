...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ocetrac-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13414&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ocetrac-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ocetrac` can be installed with:

```
conda install ocetrac
```

It is possible to list all of the versions of `ocetrac` available on your platform with:
